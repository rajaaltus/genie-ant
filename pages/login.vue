  ...
  >
    ...
    <div class="content">
      ...
      <div class="form">
        ...
        <a-form-model class="login-form" :model="loginData">
          ...
          <div class="form-actions">
            <a-button type="primary" htmlType="submit" class="login-form-button" @click="signIn">Sign in</a-button>
  ...
  methods: {
    async signIn () {
			await this.$auth.loginWith("local", {
				data: {
					identifier: this.loginData.username,
